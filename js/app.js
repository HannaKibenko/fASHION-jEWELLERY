...
if (document.querySelector('.slider-first__body')) {
	new Swiper('.slider-first__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 2,
		// spaceBetween: 21,
...
document.querySelectorAll(".filter-category__btn").forEach(el => {
...
var btnContainer = document.getElementById("filtr-product");
// Сделать все кнопки с class="btn" внутри контейнера
var btns = btnContainer.getElementsByClassName("filter-category__btn");
